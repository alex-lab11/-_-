...
void displayMenu()
{
	cout << "1. Добавить приходный" << endl;
	cout << "2. Добавить расходный" << endl;
	cout << "3. Найти операцию" << endl;
...
int main()
{
	...
	int i, x = 1000, k, j, date1, pay1 = 0, pay2 = 0, account1, account2, balance = 0, n = 0;
